...
export class DropsendService {
  ...
  private getEndpoint(): string {
    // Construir la URL del endpoint del servidor. Se puede ajustar según el entorno.
    const protocol = location.protocol.startsWith('https') ? 'wss' : 'ws';
    // Se utiliza "/server/webrtc" si se soporta WebRTC, de lo contrario "/server/fallback"
